...
class GetClient {
    ...
    save() {
        ...
        this.query = "INSERT INTO newclient (client_name,reg_date,mobile_no,alt_mobileno,address,photo,gender,tenor_month,dob,investment_amt,referalname1,referalpercent1,pan,aadhar,bank_name,acc_no,ifsc_code,branch_name,status)";

        this.query += "VALUES('" + this.client_name + "','" + this.reg_date + "','" + this.mobile_no + "', '" + this.alt_mobileno + "', '" + this.address + "','" + this.photo + "', '"
            + this.gender + "','" + this.tenor_month + "','" + this.dob + "','" + this.investment_amt + "','" + this.referalname1 + "','" + this.referalpercent1 + "', '"
    ...
    update() {
        ...
        this.query += "referalname1='" + this.referalname1 + "',referalpercent1='" + this.referalpercent1 + "', "
    ...
    list() {
        this.query = "SELECT * FROM newclient WHERE referalname1 = " + this.client_name;
        return new Promise((resolve, reject) => {
